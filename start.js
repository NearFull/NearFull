...
function addMiddleware(devServer) {
  ...
  if (proxy) {
    ...
    var vtexEnviromentName = require(paths.appPackageJson).vtexEnviromentName;
    console.log(vtexEnviromentName);
    devServer.use('/arquivos',
        httpProxyMiddleware({
            target: 'http://'+vtexEnviromentName+'.vteximg.com.br/'
        }))
  }
